...
class RssFeed {
  ...
  factory RssFeed.parse(String xmlString) {
    ...
    return RssFeed(
      ...
      seeders: channelElement.findElements('nyaa:seeders').firstOrNull?.text,
      leechers: channelElement.findElements('nyaa:leechers').firstOrNull?.text,
      size: channelElement.findElements('nyaa:size').firstOrNull?.text,
      category: channelElement.findElements('nyaa:category').firstOrNull?.text,
